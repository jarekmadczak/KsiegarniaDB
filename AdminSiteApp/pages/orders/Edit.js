...
import OrderEditForm from "../../components/OrdersEditForm";
  ...
  return (
    <Layout>
      {id ? (
         ...
         <div className="content-normal text-center"> <h1 className="text-center font-bold text-xl">Edytuj</h1> <OrderEditForm productId={id} /> </div>
