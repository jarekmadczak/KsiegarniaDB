...
export default function Nav({show}) {
  ...
  return (
    ...
    <aside className={"left-0 -left-fulltop-0 text-white p-0 fixed w-full bg-bgWhite h-full md:static md:w-auto transition-all"}>
      <div className="mb-4 mr-4 text-white-500">
        <Logo />
      </div>
      <nav className="flex flex-col gap-2">
        <Link href={'/dashboard'} className={pathname === '/dashboard' ||pathname === '/' ? activeLink : inactiveLink}>
